...
const slides = [
  {
    title: "Won design competition 2009 for Community Club & Entertainment Complex",
    location: "Izmir Town, Lahore",
  },
  {
    title: "Won design competition 2009 for Community Club & Entertainment Complex",
    location: "Izmir Town, Lahore",
    ...
    <Grid container spacing={2} sx={{ padding: { xs: "10px", sm: "16px" } }}>
       <Grid item xs={12}>
        <Box sx={{ display: "flex", alignItems: "center" ,paddingBottom:"30px"}}>
          ...
          >
           Discover Our Firm's <br /> Prestigious Awards
          </Typography>
          <hr
            style={{
              flexGrow: 1,
            ...
            <Box key={index} sx={{ padding: "0 40px" }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={3}>
                   <Box>
                    <Typography
                      sx={{ fontFamily: "Poppins-Bold", fontSize: "25px" }}
                    >
                      {slide.title}
                    </Typography>
                    <Typography
